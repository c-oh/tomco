...
?>
	...
	<div class= "footer-nav-container">
		<div class= "footer-nav">
			...
			<a class= "footer-links" href= "/#backshape-about"> <p class= "links">About Us</p></a>
			<a class= "footer-links" href= "/#backshape-events"> <p class= "links">Events</p></a>
			<a class= "footer-links" href= "/#backshape-contact"> <p class= "links">Contact</p></a>
		</div>

		<div class= "footer-nav footer-2">
			<h4 class= "footer-title"> Products</h4>
			<a class= "footer-links" href= "/floral"> <p class= "links">Floral</p></a>
			<a class= "footer-links" href= "/furniture"> <p class= "links">Furniture</p></a>
			<a class= "footer-links" href= "/links"> <p class= "links">Garden</p></a>
			<a class= "footer-links" href= "/homedecor"> <p class= "links">Homedecor</p></a>
			<a class= "footer-links" href= "/houseware"> <p class= "links">Houseware</p></a>
			<a class= "footer-links" href= "/kitchenware"> <p class= "links">Kitchenware</p></a>
			<a class= "footer-links" href= "/seasonal"> <p class= "links">Seasonal</p></a>
		</div>
	</div>
	<div class= "footer-nav-container-2">
		<div class="site-info">
			...
			<p class="email"> <i class="fa fa-envelope" aria-hidden="true"></i> info@tomco.hk</p>
		</div>
		<!-- .site-info -->
		<div class="social">
